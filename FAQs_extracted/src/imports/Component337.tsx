import svgPaths from "./svg-b7s26w7uh3";
...
function Frame() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[20px] items-center left-1/2 top-[calc(50%-272px)] w-[335px]">
      <p className="bg-center bg-clip-text bg-cover bg-no-repeat font-['Sora:SemiBold',sans-serif] font-semibold leading-[40px] min-w-full relative shrink-0 text-[36px] text-[transparent] text-center tracking-[-1.44px] w-[min-content]" style={{ backgroundImage: `url('${imgFrequentlyAskedQuestions}')` }}>
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start min-h-px min-w-px relative">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[16px] text-white w-full">What ROI can I expect?</p>
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[19px] relative shrink-0 text-[14px] text-[rgba(255,255,255,0.7)] w-full">On average, our clients see a 10–30% increase in annual revenue and cover the cost of our services within 6 months.</p>
    </div>
  );
}
            ...
            <div className="absolute inset-[37.5%_20.83%]" data-name="Vector">
              <div className="absolute inset-[-12.5%_-5.36%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.9167 6.25001">
                  <path d={svgPaths.p3dd17100} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
                </svg>
              </div>
            </div>
          </div>
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[16px] text-white w-full">How quickly will I see results?</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[22px] relative shrink-0 text-[16px] text-white w-full">What’s the minimum commitment?</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[16px] text-white w-full">Why is CRO a monthly service?</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[16px] text-white w-full">Is CRO only for big stores?</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[16px] text-white w-full">What metrics do you track?</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#020601] relative size-full" data-name="Component 337">
      <Frame />
      <Frame1 />
    </div>
  );
