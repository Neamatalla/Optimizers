                                ...
                                <div className="content-stretch flex flex-col gap-[3vh] items-start relative shrink-0 w-full">
                                    <div className="content-stretch flex gap-[1.5vh] h-auto items-center relative shrink-0 w-full">
                                        ...
                                        <div className="content-stretch flex flex-col gap-[1vh] items-start justify-center relative shrink-0">
                                            <div className="flex flex-col font-['Sora',sans-serif] font-semibold h-auto justify-center leading-[1.2] relative shrink-0 text-[32px] text-white tracking-[-0.02em] w-full"><p>{t('Regal Honey')}</p></div>
                                            <div className="bg-[rgba(252,211,77,0.15)] content-stretch flex items-center justify-center px-[12px] py-[6px] relative rounded-[100px] shrink-0">
                                                <p className="font-['Sora',sans-serif] font-normal leading-normal relative shrink-0 text-[#fde68a] text-[14px]">{t('Food & Beverage')}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
                                        <p className="font-['Sora',sans-serif] font-normal leading-relaxed relative shrink-0 text-[18px] text-white w-full">{t('Premium honey retailer offering natural and organic honey products across Kuwait.')}</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                            ...
                            <motion.div style={{ y: counterY || 0, willChange: 'transform' }}>
                                <div className="content-stretch flex flex-col gap-[2.4vh] items-start relative shrink-0 w-full">
                                    <div className="content-stretch flex flex-col gap-[0.8vh] items-start relative shrink-0 w-full">
                                        <p className="font-['Sora',sans-serif] font-semibold leading-normal min-w-full relative shrink-0 text-[#fde68a] text-[18px]">{t('Our Goal:')}</p>
                                        <p className="font-['Sora',sans-serif] font-normal leading-normal relative shrink-0 text-[14px] text-white">{t('ECR uplift across all product categories.')}</p>
                                    </div>
                                    <div className="content-stretch flex flex-col gap-[0.8vh] items-start relative shrink-0 w-full">
                                        <p className="font-['Sora',sans-serif] font-semibold leading-normal min-w-full relative shrink-0 text-[#fde68a] text-[18px]">{t('Areas of Improvement:')}</p>
                                        <p className="font-['Sora',sans-serif] font-normal leading-normal relative shrink-0 text-[14px] text-white">{t('Homepage, product details page.')}</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                ...
                <div className="lg:hidden absolute inset-0 flex flex-col items-center px-5 pt-[6vh] pb-6 gap-3 w-full pointer-events-auto overflow-y-auto">
                    <div className="flex items-center gap-3 w-full max-w-[320px]">
                        ...
                        <div className="flex flex-col gap-0.5">
                            <p className="font-['Sora',sans-serif] font-semibold text-[18px] text-white tracking-[-0.02em] leading-[1.2]">{t('Regal Honey')}</p>
                            <div className="bg-[rgba(252,211,77,0.15)] flex items-center justify-center px-[8px] py-[3px] rounded-[100px] w-fit">
                                <p className="font-['Sora',sans-serif] font-normal text-[11px] text-[#fde68a]">{t('Food & Beverage')}</p>
                            </div>
                        </div>
                    </div>
                    <p className="font-['Sora',sans-serif] font-normal leading-relaxed text-[13px] text-white/80 text-center max-w-[320px]">{t('Premium honey retailer offering natural and organic honey products across Kuwait.')}</p>
                    ...
                    <div className="flex gap-6 w-full max-w-[320px]">
                        <div className="flex flex-col gap-0.5 flex-1">
                            <p className="font-['Sora',sans-serif] font-semibold text-[#fde68a] text-[13px]">{t('Our Goal:')}</p>
                            <p className="font-['Sora',sans-serif] font-normal text-[11px] text-white/80">{t('ECR uplift across all product categories.')}</p>
                        </div>
                        <div className="flex flex-col gap-0.5 flex-1">
                            <p className="font-['Sora',sans-serif] font-semibold text-[#fde68a] text-[13px]">{t('Areas of Improvement:')}</p>
                            <p className="font-['Sora',sans-serif] font-normal text-[11px] text-white/80">{t('Homepage, product details page.')}</p>
                        </div>
                    </div>
                </div>
