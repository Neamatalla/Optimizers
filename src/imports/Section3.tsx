...
const Section3 = memo(({ isActive, bgOpacity, contentOpacity, counterY, mockupX, mockupY }: {
    isActive: boolean;
    bgOpacity: any;
    contentOpacity: any;
    counterY?: any;
            ...
            >
                <div className="absolute inset-[-28.23%_-11.01%_-20.96%_-9.99%]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2425.07 1598.54">
                        <g id="bg_3" opacity="0.7">
                            <g id="light_3">
                                <path d={svgPaths.p30326f80} stroke="url(#paint0_linear_sec3)" strokeWidth="137.142" filter="url(#filter0_iif_sec3)" />
                            </g>
                            <g id="light2_3">
                                <path d={svgPaths.p1c0fb80} fill="#1D1A1A" filter="url(#filter1_f_sec3)" />
                            </g>
                        </g>
                        <defs>
                            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" id="filter0_iif_sec3">
                                <feGaussianBlur stdDeviation="20" />
                            </filter>
                            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" id="filter1_f_sec3">
                                <feGaussianBlur stdDeviation="20" />
                            </filter>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_sec3" x1="1829.54" x2="586.351" y1="477.125" y2="1492.92">
                                <stop stopColor="#04060A" />
                                <stop offset="0.403657" stopColor="#E46A6A" />
                                <stop offset="0.615" stopColor="#371616" />
                                ...
                                <div className="content-stretch flex flex-col gap-[3vh] items-start relative shrink-0 w-full">
                                    <div className="content-stretch flex gap-[1.5vh] h-auto items-center relative shrink-0 w-full">
                                        <div className="relative shrink-0 size-[7.3vh] min-w-[50px] min-h-[50px]">
                                            <img alt="" className="block max-w-none size-full" src={imgProfilePhoto2} decoding="async" />
                                        </div>
