...
export default function MeetTheTeam() {
    ...
    return (
        <div className="bg-[#020601] relative w-full overflow-hidden">
            ...
            <div className="lg:hidden py-10 px-5">
                <p className="font-['Sora',sans-serif] font-semibold text-[28px] text-center bg-clip-text text-transparent bg-gradient-to-b from-[rgba(255,255,255,0.6)] to-[rgba(20,23,19,0.5)] mb-6">
                    Meet The Team
                </p>
                <div className="grid grid-cols-2 gap-3">
                    {teamMembers.map((member, i) => (
                        <div
                            key={i}
                            className="relative rounded-2xl overflow-hidden bg-[#0a0a0a] border border-white/10"
                            style={{ borderColor: `${member.color}33` }}
                        >
                            <div className="aspect-[3/3.5] relative overflow-hidden">
                                <img
                                    src={member.image}
                                    alt={member.name}
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-3">
                                <p className="font-['Sora',sans-serif] font-semibold text-[13px] text-white leading-tight">
                                    {member.name}
                                </p>
                                <p className="font-['Sora',sans-serif] font-normal text-[11px] text-white/50 mt-0.5">
                                    {member.role}
                                </p>
                            </div>
                        </div>
